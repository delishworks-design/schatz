...
class SupabasePlugin {
  ...
  static List<Tool> get tools => [
    Tool(
      ...
      parameters: {
        'sql': ToolParameter(name: 'sql', description: 'SQL query', type: ToolParameterType.string, required: true),
      },
    ),
    Tool(
      id: 'table.list',
    ...
    Tool(
      ...
      type: ToolType.read,
      parameters: {
        'table': ToolParameter(name: 'table', description: 'Table name', type: ToolParameterType.string, required: true),
        'columns': ToolParameter(name: 'columns', description: 'Columns to select', type: ToolParameterType.list),
        'filters': ToolParameter(name: 'filters', description: 'Filter conditions', type: ToolParameterType.map),
        'limit': ToolParameter(name: 'limit', description: 'Limit results', type: ToolParameterType.int),
      },
    ),
    Tool(
      id: 'row.insert',
      ...
      parameters: {
        'table': ToolParameter(name: 'table', description: 'Table name', type: ToolParameterType.string, required: true),
        'data': ToolParameter(name: 'data', description: 'Row data', type: ToolParameterType.map, required: true),
      },
    ),
    Tool(
      id: 'row.update',
      ...
      parameters: {
        'table': ToolParameter(name: 'table', description: 'Table name', type: ToolParameterType.string, required: true),
        'data': ToolParameter(name: 'data', description: 'Data to update', type: ToolParameterType.map, required: true),
        'filters': ToolParameter(name: 'filters', description: 'Filter conditions', type: ToolParameterType.map, required: true),
      },
    ),
    Tool(
      id: 'row.delete',
    ...
    Tool(
      ...
      type: ToolType.write,
      parameters: {
        'email': ToolParameter(name: 'email', description: 'Email', type: ToolParameterType.string, required: true),
        'password': ToolParameter(name: 'password', description: 'Password', type: ToolParameterType.string, required: true),
      },
    ),
    Tool(
      id: 'auth.signin',
  ...
  static Future<ToolResult> _runQuery(Map<String, dynamic> params) async {
    try {
      ...
      final response = await client.post('/rpc/run_query', data: {'query': params['sql']});
  ...
  static Future<ToolResult> _selectRows(Map<String, dynamic> params) async {
    try {
      ...
      final response = await client.get('/$table', queryParameters: queryParams);
